...
def CalData(kk0,kk1,kk2,kk3):
    ...
    if Flag:
        kk0=kk0-0x80
        d=(kk0*256+kk1+(kk2*256+kk3)*0.0001)
        d=-1*d
    else:
       a = 0
       d=(kk0*256+kk1+(kk2*256+kk3)*0.0001)
...
#add = 1
#B3 = 18
#FlagOpenOrClosed = 0x43 #C 0x43 O 0x4f
#Ch = 0
#sentOpenOrClose(add,B3,FlagOpenOrClosed,Ch)
#sleep(0.02)
#B3Raed = 19
#FlagOpenOrclose = ReadOpenOrClsoe(add,B3Raed,Ch)
...
print(FlagOpenOrclose)
sleep(0.02)
#sendVf(10.005) #发送10.001V Send 10.001V
sendMovef(10.001);
sleep(0.2)
####################################### 可用读取位移数据
add = 1
B3= 6 #//读取电压数据 5 读取位移 6
ch = 0
ReadVolt = 0
ReadVolt = readVoltOrMove(add,B3,ch)
print(ReadVolt)
